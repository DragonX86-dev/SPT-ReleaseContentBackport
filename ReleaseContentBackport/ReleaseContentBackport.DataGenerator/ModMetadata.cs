...
{
    public override string ModGuid { get; init; } = "com.dragonx86.release-content-backport-datagen";
    public override string Name { get; init; } = "Release Content Backport DataGenerator";
